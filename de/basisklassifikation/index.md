    ...
    <div class="hero-main">
      ...
      <div class="cards">
        <div class="card-1">
          ...
          <ul>
            <li><a href="ueber-die-bk/" class="portal-link">Über die BK</a></li>
          </ul>
        ...
        <div class="card-2">
          ...
          <a href="anwendungsrichtlinien/" class="card-title-link">
        ...
        <div class="card-4">
          ...
          <ul>
            <li><a href="relaunch/" class="portal-link">BK-Relaunch</a></li>
            <li><a href="uebersetzungsprojekt/" class="portal-link">BK-Übersetzung</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="portal-links">
    <div class="portal-link-item">
      ...
      <div class="portal-link-text">
        <span class="label">
          <a href="bk-redaktion/">BK-Redaktion</a>
        </span>
      </div>
    </div>
    ...
    <div class="portal-link-item">
      ...
      <div class="portal-link-text">
        <span class="label">
          <a href="neuigkeiten/">Neuigkeiten &amp; Updates</a>
        </span>
      </div>
    </div>
  </div>
