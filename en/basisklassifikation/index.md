    ...
    <div class="hero-main">
      ...
      <div class="cards">
        ...
        <div class="card-4">
          ...
          <ul>
            <li><a href="/basisklassifikation/relaunch/" class="portal-link">BK-Relaunch</a></li>
            <li><a href="/basisklassifikation/uebersetzungsprojekt/" class="portal-link">BK-Übersetzung</a></li>
          </ul>
        </div>
      </div>
    </div>
