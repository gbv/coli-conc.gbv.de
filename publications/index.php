...
$BASE='..';
$SOURCES='https://github.com/gbv/coli-conc.gbv.de/blob/master/publications/index.php';
...
?>
    ...
    <div class="container">
      <h2>Publications
        <a href="https://www.zotero.org/groups/coli-conc/items/">
          <img border="0" alt="Get Zotero" title="Get Zotero" 
            src="https://www.zotero.org/images/promote/get_zotero_80x15.gif">
        </a>
      </h2>
      <p>
...
<!--        <li>
      ...
      <table class="table">
        <thead>
          <tr>
            <th>name, code, and description</th>
        ...
        <tr>
          <td>
            <a href="https://github.com/gbv/jskos-php">jskos-php</a>
            PHP library for JSKOS
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/jskos-php"><img src="https://travis-ci.org/gbv/jskos-php.svg"></a>
          </td>
          <td>
            <a href="https://packagist.org/packages/gbv/jskos"><img src="https://img.shields.io/packagist/v/gbv/jskos.svg"></a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/jskos-rdf">jskos-rdf</a>
            PHP library to process JSKOS and RDF data
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/jskos-rdf"><img src="https://travis-ci.org/gbv/jskos-rdf.svg"></a>
          </td>
          <td>
            <a href="https://packagist.org/packages/gbv/jskos-rdf"><img src="https://img.shields.io/packagist/v/gbv/jskos-rdf.svg"></a>
          </td>
        </tr>
        <tr>
          <td>
	        <a href="https://github.com/gbv/wdmapper">wdmapper</a>
            Wikidata authority file mapping tool
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/wdmapper"><img src="https://travis-ci.org/gbv/wdmapper.svg"></a>
          </td>
          <td>
            <a href="https://pypi.python.org/pypi/wdmapper"><img src="https://badge.fury.io/py/wdmapper.svg" height="20"/></a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/skos2jskos">skos2jskos</a>
            Convert SKOS/RDF to JSKOS
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/skos2jskos"><img src="https://travis-ci.org/gbv/skos2jskos.svg"></a>
          </td>
          <td>
            <a href="https://metacpan.org/release/App-skos2jskos"><img src="https://badge.fury.io/pl/App-skos2jskos.svg" alt="CPAN version" height="20"></a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/ng-suggest">ng-suggest</a>
            AngularJS module for Typeahead via OpenSearch Suggestions
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/ng-suggest"><img src="https://travis-ci.org/gbv/ng-suggest.svg?branch=master" height="20"></a>
          </td>
          <td>
            <a href="https://www.npmjs.com/package/ng-suggest"><img src="https://img.shields.io/npm/v/ng-suggest.svg?style=flat"></a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/ng-skos">ng-skos</a>
            AngularJS module for JSKOS
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/ng-skos"><img src="https://travis-ci.org/gbv/ng-skos.svg"></a>
          </td>
          <td>
            <a href="https://www.npmjs.com/package/ng-skos"><img src="https://img.shields.io/npm/v/ng-skos.svg?style=flat"></a>
          </td>
        </tr>
        <tr>
          <td>
	        <a href="https://github.com/gbv/cocoda-db">cocoda-db</a>
            database backend to store and serve JSKOS
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/cocoda-db"><img src="https://travis-ci.org/gbv/cocoda-db.svg"></a>
          </td>
          <td>
            <a href="https://github.com/gbv/cocoda-db/releases"><img src="https://img.shields.io/github/release/gbv/cocoda-db.svg" height="20"/></a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/cocoda">cocoda</a>
            web application mapping tool
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/cocoda"><img src="https://travis-ci.org/gbv/cocoda.svg"></a>
          </td>
          <td>
            <em>prototype</em>
          </td>
        ...
        <tr>
          <td>
            <a href="https://github.com/gbv/jskos-php-examples">jskos-php-examples</a>
            Sample applications of jskos-php, e.g. wrappers of terminology
            services to JSKOS-API
          </td>
          <td>
            <a href="https://travis-ci.org/gbv/jskos-php-examples"><img src="https://travis-ci.org/gbv/jskos-php-examples.svg"></a>
          </td>
          <td>
            <a href="https://jskos-php-examples.herokuapp.com/">live demo</a>
          </td>
        </tr>
        <tr>
          <td>
            <a href="https://github.com/gbv/cocoda-mappings">cocoda-mappings</a>
      ...
      <ul>
        <li>
          <a href="bartoc">BARTOC database dumps and reports</a>
        </li>
        <li>
          <a href="licenses">coli-conc licenses</a>
        </li>
        <li>
          <a href="../concordances/wikidata">Mappings from Wikidata</a>
        </li>
          See <a href="https://github.com/gbv/jskos-data">jskos-data</a> repository for a collection
